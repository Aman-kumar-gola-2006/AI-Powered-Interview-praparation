...
// --- Types ---
type Section = 'home' | 'notes' | 'interview' | 'problems' | 'videos' | 'leaderboard' | 'profile' | 'contact';
type UserProfile = {
  name: string;
  points: number;
  level: number;
      ...
      {view === 'landing' ? (
        <div className="max-w-md w-full text-center space-y-10 animate-in fade-in slide-in-from-bottom-6 duration-700">
          ...
          <div className="space-y-4 pt-6">
            ...
            >
              <span className="font-bold text-lg text-white">Register Free</span>
            </button>
            <p className="text-xs font-bold text-slate-500 uppercase tracking-widest mt-4">Join 10,000+ Aspirants today</p>
          </div>
        </div>
      ) : (
        <div className="max-w-md w-full space-y-8 animate-in fade-in slide-in-from-right-8 duration-500">
          <div className="text-center space-y-2">
            <button onClick={() => setView('landing')} className="text-indigo-400 font-bold text-sm uppercase tracking-widest hover:text-indigo-300 transition-colors">
              ← Back to Home
            </button>
            <h2 className="text-3xl font-black text-white uppercase tracking-tighter">Create Account</h2>
            <p className="text-slate-400 font-medium">Start your journey to a top-tier tech career.</p>
          </div>

          <GlassCard className="space-y-6 p-8">
            <div className="space-y-2">
              <label className="text-xs font-bold text-slate-500 uppercase tracking-widest pl-1">Full Candidate Name</label>
              <div className="bg-white/5 border border-white/10 rounded-xl flex items-center px-4 focus-within:ring-2 ring-indigo-500 transition-all">
                <User className="w-5 h-5 text-slate-500" />
                <input
                  value={formData.name} onChange={e => setFormData({ ...formData, name: e.target.value })}
                  className="w-full bg-transparent p-4 outline-none font-bold text-white placeholder-slate-600"
            ...
            <button
              ...
              className="w-full py-5 bg-indigo-600 rounded-xl font-black text-white hover:bg-indigo-500 transition-all shadow-xl flex items-center justify-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading ? (
                <>
...
const App = () => {
  ...
  return (
    <div className="flex min-h-screen bg-[#020617] overflow-hidden text-white font-sans">
      ...
      <aside className={`fixed md:sticky top-0 h-screen border-r border-white/5 glass transition-all duration-500 z-50 flex flex-col ${isSidebarOpen ? 'translate-x-0 w-72' : '-translate-x-full md:translate-x-0 md:w-24'} p-4 bg-[#020617]/90 backdrop-blur-xl md:bg-transparent`}>
        <div className="flex items-center justify-between md:justify-start space-x-4 px-4 py-8">
        ...
        <div className="flex-1 space-y-2 mt-4 px-2 overflow-y-auto">
          ...
          <NavItem s="contact" icon={Mail} label="Contact Support" />
        </div>
        ...
        <div className="mt-auto px-2 pb-6 space-y-2">
          ...
          <button
            ...
            className="hidden md:flex w-full items-center justify-center p-4 text-slate-500 hover:text-white transition-all"
          >
      ...
      <div className="flex-1 h-screen overflow-y-auto no-scrollbar relative flex flex-col">
        <header className="sticky top-0 z-40 px-6 md:px-10 py-6 glass border-b border-white/5 flex items-center justify-between backdrop-blur-xl bg-[#020617]/40">
        ...
        <main className="p-4 md:p-10 pb-20">
          ...
          {activeSection === 'contact' && (
            <div className="max-w-3xl mx-auto py-10 space-y-8 animate-in fade-in slide-in-from-bottom-5 duration-500">
              <div className="text-center space-y-4">
                <div className="w-20 h-20 bg-indigo-500/20 rounded-[2rem] flex items-center justify-center mx-auto border-2 border-indigo-500/30">
                  <Mail className="text-indigo-400 w-10 h-10" />
                </div>
                <h2 className="text-4xl font-black text-white uppercase tracking-tighter">Contact UA Team</h2>
                <p className="text-slate-400 text-lg font-medium">Have questions? We're here to help you ace your preparation.</p>
              </div>
              ...
              <GlassCard className="p-10 space-y-8">
                <div className="grid md:grid-cols-2 gap-8">
                  <div className="space-y-2">
                    ...
                    <input
                      className="w-full bg-white/5 border border-white/10 p-4 rounded-xl outline-none focus:ring-2 ring-indigo-500 transition-all text-white font-bold placeholder-slate-600"
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    className="w-full bg-white/5 border border-white/10 p-4 rounded-xl outline-none focus:ring-2 ring-indigo-500 transition-all text-white font-medium min-h-[150px] resize-none placeholder-slate-600"
                    placeholder="How can we assist you today?"
                  />
                </div>
                <button className="w-full py-5 bg-indigo-600 rounded-xl font-black text-white hover:bg-indigo-700 transition-all shadow-lg flex items-center justify-center space-x-2">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <GlassCard className="text-center py-6">
                  ...
                  <p className="text-white font-bold mt-1">support@uateam.com</p>
                </GlassCard>
                <GlassCard className="text-center py-6">
                  <p className="text-xs font-bold text-slate-500 uppercase">Headquarters</p>
                  <p className="text-white font-bold mt-1">Tech Park, India</p>
                </GlassCard>
                <GlassCard className="text-center py-6">
                  <p className="text-xs font-bold text-slate-500 uppercase">Working Hours</p>
                  <p className="text-white font-bold mt-1">Mon - Fri, 9AM - 6PM</p>
                </GlassCard>
              </div>
            </div>
          )}
          ...
          <footer className="mt-20 py-8 border-t border-white/5 text-center">
            <p className="text-slate-500 font-bold text-sm">
              Made with UA Team &copy; 2025. All Rights Reserved.
            </p>
          </footer>
        </main>
      </div>
